...
public class L_1025_DivisorGame {

    /*
        Alice and Bob take turns playing a game, with Alice
        starting first.

        Initially, there is a number N on the chalkboard(黑板).
        ...
        Example 2:
            Input: 3
            Output: false
            Explanation: Alice chooses 1, Bob chooses 1, and Alice has
            no more moves.
    ...
    public static void main(String[] args) {
        L_1025_DivisorGame l = new L_1025_DivisorGame();
        int N = 2;
