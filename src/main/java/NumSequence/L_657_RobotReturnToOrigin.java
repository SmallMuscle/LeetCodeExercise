...
public class L_657_RobotReturnToOrigin {
    ...
    /*
        ...
        L (left), U (up), and D (down). If the robot returns to the origin
    ...
    public static void main(String[] args) {
        L_657_RobotReturnToOrigin l = new L_657_RobotReturnToOrigin();
        String moves = "UD";
        System.out.println(l.judgeCircle(moves));
        moves = "LL";
        System.out.println(l.judgeCircle(moves));
    }
